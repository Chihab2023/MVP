...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	$login_header_text = empty( $login_header_title ) ? __( 'Powered by ' ) : $login_header_title;
	...
	case 'confirm_admin_email':
		...
		<form class="admin-email-confirm-form" name="admin-email-confirm-form" action="<?php echo esc_url( site_url( 'wp-login.php?action=confirm_admin_email', 'login_post' ) ); ?>" method="post">
			...
			<p class="admin-email__details">
				...
				/* translators: URL to the  help section about admin email. */
				$admin_email_help_url = __( 'https://.org/documentation/article/settings-general-screen/#email-address' );
			...
			if ( headers_sent() ) {
				$user = new WP_Error(
					...
					sprintf(
						...
						__( 'https://.org/documentation/article/cookies/' ),
				...
				$user = new WP_Error(
					...
					sprintf(
						...
						__( '<strong>Error:</strong> Cookies are blocked or not supported by your browser. You must <a href="%s">enable cookies</a> to use .' ),
						__( 'https://.org/documentation/article/cookies/#enable-cookies-in-your-browser' )
					)
				);
			}
		}
